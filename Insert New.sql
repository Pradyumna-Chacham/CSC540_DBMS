...
('00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000101'), -- Olivia Bennett -> Book
('00000000-0000-0000-0000-000000000301', '00000000-0000-0000-0000-000000000102'), -- Olivia Bennett -> Tech Weekly
('00000000-0000-0000-0000-000000000302', '00000000-0000-0000-0000-000000000102'), -- Helena Strauss -> Tech Weekly
('00000000-0000-0000-0000-000000000303', '00000000-0000-0000-0000-000000000103'); -- Daniel Whitmore -> Global Affairs Review
...
-- =========================================================
-- 5. CONTENT (CHAPTERS + ARTICLES)
-- =========================================================
INSERT INTO Content
(id, content_title, topic, date_written, content_type, content_text, edition_issue_id) VALUES
-- Chapters for the book
('00000000-0000-0000-0000-000000000501',
 'Ch1 Distributed Transactions',
 'Distributed Systems',
 '2025-03-15',
 'CHAPTER',
...
('00000000-0000-0000-0000-000000000502',
 'Ch1 Distributed Transactions (Edition 2)',
 'Distributed Systems',
 '2026-02-01',
 'CHAPTER',
...
-- Articles for Global Affairs Review
('00000000-0000-0000-0000-000000000508',
 'Election Trends Worldwide',
...
(id, name, address, type, phone_number, contact_name, balance, city, country) VALUES
('00000000-0000-0000-0000-000000000201',
 'Triangle Books',
 '142 Hillsborough Street, Raleigh, NC 27603',
 'BOOKSTORE',
 '9195552101',
 'Laura Thompson',
 4850.00,
...
('00000000-0000-0000-0000-000000000202',
 'Eastern Academic Wholesale',
 '850 Logistics Parkway, Charlotte, NC 28208',
 'WHOLESALE',
 '7045557782',
 'Mark Reynolds',
 12300.00,
...
('00000000-0000-0000-0000-000000000203',
 ...
 '336 Fayetteville Street, Raleigh, NC 27601',
 'LIBRARY',
 '9195554433',
 'Emily Carter',
 0.00,
...
('00000000-0000-0000-0000-000000000204',
 'Capitol City Books',
 '91 Market Square, Durham, NC 27701',
 'BOOKSTORE',
 '9195556610',
 'Daniel Wright',
 2175.50,
...
-- =========================================================
-- 8. ORDERS
-- required_by_date assumed as 14 days after order_date
-- billed_date and total_billed_amount left NULL unless demo specifies
-- =========================================================
INSERT INTO Orders
(id, quantity, unit_price, ship_cost, order_date, required_by_date, billed_date, total_billed_amount, distributor_id, edition_issue_id) VALUES
...
-- =========================================================
-- 9. USER PAYMENTS (AUTHORS + EDITORS)
-- =========================================================
INSERT INTO UserPayments
(id, payment_type, amount, issue_date, claimed_date, person_id) VALUES
-- Author payments for chapters
('00000000-0000-0000-0000-000000000601', 'BOOK_AUTHORSHIP',    2500.00, '2025-03-20', '2025-04-05', '00000000-0000-0000-0000-000000000304'),
('00000000-0000-0000-0000-000000000602', 'BOOK_AUTHORSHIP',    1000.00, '2026-02-05', NULL,          '00000000-0000-0000-0000-000000000304'),
('00000000-0000-0000-0000-000000000603', 'BOOK_AUTHORSHIP',    2000.00, '2026-02-10', NULL,          '00000000-0000-0000-0000-000000000304'),

-- Author payments for articles
('00000000-0000-0000-0000-000000000604', 'ARTICLE_AUTHORSHIP', 1200.00, '2026-01-28', '2026-02-03', '00000000-0000-0000-0000-000000000305'),
('00000000-0000-0000-0000-000000000605', 'ARTICLE_AUTHORSHIP', 1100.00, '2026-01-30', NULL,          '00000000-0000-0000-0000-000000000306'),
('00000000-0000-0000-0000-000000000606', 'ARTICLE_AUTHORSHIP', 1150.00, '2026-01-25', '2026-02-02', '00000000-0000-0000-0000-000000000307'),
('00000000-0000-0000-0000-000000000607', 'ARTICLE_AUTHORSHIP', 1300.00, '2026-02-05', NULL,          '00000000-0000-0000-0000-000000000308'),
('00000000-0000-0000-0000-000000000608', 'ARTICLE_AUTHORSHIP', 1250.00, '2025-12-20', '2026-01-05', '00000000-0000-0000-0000-000000000309'),
('00000000-0000-0000-0000-000000000609', 'ARTICLE_AUTHORSHIP', 1180.00, '2026-01-10', NULL,          '00000000-0000-0000-0000-000000000310'),

-- Editor payments
('00000000-0000-0000-0000-000000000610', 'EDITORIAL_WORK',     4000.00, '2025-03-15', '2025-04-10', '00000000-0000-0000-0000-000000000301'),
('00000000-0000-0000-0000-000000000611', 'EDITORIAL_WORK',     4000.00, '2026-02-01', '2026-02-10', '00000000-0000-0000-0000-000000000301'),
('00000000-0000-0000-0000-000000000612', 'EDITORIAL_WORK',     2500.00, '2026-02-28', NULL,          '00000000-0000-0000-0000-000000000301'),
('00000000-0000-0000-0000-000000000613', 'EDITORIAL_WORK',     2000.00, '2026-02-28', '2026-03-05', '00000000-0000-0000-0000-000000000302'),
('00000000-0000-0000-0000-000000000614', 'EDITORIAL_WORK',     3000.00, '2026-01-31', '2026-02-07', '00000000-0000-0000-0000-000000000303'),
('00000000-0000-0000-0000-000000000615', 'EDITORIAL_WORK',     3000.00, '2026-02-28', NULL,          '00000000-0000-0000-0000-000000000303');
